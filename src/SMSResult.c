...
int
SMSResult_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
SMSResult_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
SMSResult_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	SMSResult_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
SMSResult_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
SMSResult_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
SMSResult_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
SMSResult_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
SMSResult_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
asn_TYPE_descriptor_t asn_DEF_SMSResult = {
	"SMSResult",
	"SMSResult",
	SMSResult_free,
	SMSResult_print,
	SMSResult_constraint,
	SMSResult_decode_ber,
	SMSResult_encode_der,
	SMSResult_decode_xer,
	SMSResult_encode_xer,
