...
static asn_INTEGER_enum_map_t asn_MAP_DefaultGPRS_Handling_value2enum_1[] = {
	{ 0,	19,	"continueTransaction" },
	{ 1,	18,	"releaseTransaction" }
	/* This list is extensible */
};
static unsigned int asn_MAP_DefaultGPRS_Handling_enum2value_1[] = {
	0,	/* continueTransaction(0) */
	1	/* releaseTransaction(1) */
	/* This list is extensible */
};
static asn_INTEGER_specifics_t asn_SPC_DefaultGPRS_Handling_specs_1 = {
	asn_MAP_DefaultGPRS_Handling_value2enum_1,	/* "tag" => N; sorted by tag */
	asn_MAP_DefaultGPRS_Handling_enum2value_1,	/* N => "tag"; sorted by N */
...
static ber_tlv_tag_t asn_DEF_DefaultGPRS_Handling_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_DefaultGPRS_Handling = {
	...
	asn_DEF_DefaultGPRS_Handling_tags_1,
	sizeof(asn_DEF_DefaultGPRS_Handling_tags_1)
		/sizeof(asn_DEF_DefaultGPRS_Handling_tags_1[0]), /* 1 */
	asn_DEF_DefaultGPRS_Handling_tags_1,	/* Same as above */
	sizeof(asn_DEF_DefaultGPRS_Handling_tags_1)
		/sizeof(asn_DEF_DefaultGPRS_Handling_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	0, 0,	/* Defined elsewhere */
	&asn_SPC_DefaultGPRS_Handling_specs_1	/* Additional specs */
};
